  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        path={BLOG_PATH}
        ogType="article"
        ogTitle="Why Website Change Monitors Fail Silently on JavaScript-Heavy Sites"
        twitterTitle="Why Website Change Monitors Fail Silently on JavaScript-Heavy Sites"
        jsonLd={jsonLd}
      />
      <PublicNav />
        ...
        <div className="prose prose-invert max-w-none space-y-6">
          ...
          <div className="bg-secondary/50 rounded-lg p-6 mt-10 border border-border">
            ...
            <p className="text-muted-foreground mb-4">
              The free plan includes 3 monitored pages. No credit card required.
            </p>
