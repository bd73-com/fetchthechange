...
const faqSections: FAQSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Yes. The free plan includes 5 monitors with daily checks and email notifications. You can upgrade to Pro or Power plans for more monitors and higher check frequencies.",
      },
    ],
  },
  {
